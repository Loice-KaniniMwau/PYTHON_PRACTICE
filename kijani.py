...
# class home_page(self,Availableitems,itemsonoffer):



    # def __init__(self,Availableitems,itemsonoffer) :
        


# class Available_items:
#     def __init__(self,item_name,price,addtocart) :
#         self.item_name=item_name
#         self.price=price
#         self.addtocart=addtocart
# class items_onoffer:
#     def __init__(self,item_name,offerprice,addtocart):
#         self.item_name=item_name
